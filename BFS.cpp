...
cout<<"Enter number of vertices"<<endl; cin>>vt;
...
for(int i=0;i<e;i++) 
{
cout<<"Enter from"<<endl; cin>>u;
cout<<"Enter To"<<endl; cin>>v;
g.addEdge(u,v); 
}

cout<<"Enter start vertex"<<endl; cin>>start;
cout<<"Breadth First traversal of the Graph is "<<endl; g.BFS(start);
return 0; 
